    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li class='active'>Rastrear tus pedidos</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="body-content outer-top-bd">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <span class="title-tag inner-top-vs">
                        Por favor ingresa tu ID de pedido en el cuadro de abajo y presiona Enter.
                        Este ID te fue entregado en tu recibo y en el correo de confirmación que debiste recibir.
                    </span>

                    <form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
                        <div class="form-group">
                            <label class="info-title" for="exampleOrderId1">ID del Pedido</label>
    ...
    <!-- Demo: puede ser eliminado en producción -->
