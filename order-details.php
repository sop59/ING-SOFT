...
<html lang="en">
	<head>
		...
		<!-- Solo para demostración. Debe eliminarse en producción -->
		<link rel="stylesheet" href="assets/css/config.css">

		<link href="assets/css/green.css" rel="alternate stylesheet" title="Color verde">
		<link href="assets/css/blue.css" rel="alternate stylesheet" title="Color azul">
		<link href="assets/css/red.css" rel="alternate stylesheet" title="Color rojo">
		<link href="assets/css/orange.css" rel="alternate stylesheet" title="Color naranja">
		<link href="assets/css/dark-green.css" rel="alternate stylesheet" title="Color verde oscuro">
...
<?php $cnt=$cnt+1;} } else { ?>
				<tr><td colspan="8">El ID de pedido o el correo electrónico registrado no son válidos</td></tr>
				<?php } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
...
<!-- ============================================== CARRUSEL DE MARCAS : FIN ============================================== -->	</div><!-- /.container -->
</div><!-- /.body-content -->
<?php include('includes/footer.php');?>
	...
	<!-- Solo para demostración – puede eliminarse en producción -->
	...
	<!-- Solo para demostración – puede eliminarse en producción : Fin -->
</body>
</html>
