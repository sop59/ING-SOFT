...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
	$sql=mysqli_query($con,"update subcategory set categoryid='$categoria',subcategory='$subcategoria',updationDate='$currentTime' where id='$id'");
...
<head>
	...
	<title>Administrador | Editar Subcategoría</title>
