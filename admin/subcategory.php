...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"insert into subcategory(categoryid,subcategory) values('$categoria','$subcategoria')");
...
<head>
	...
	<title>Administrador | Subcategorías</title>
...
<?php if(isset($_GET['del'])) { ?>
	<div class="alert alert-error">
		<button type="button" class="close" data-dismiss="alert">×</button>
		<strong>¡Aviso!</strong> <?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
	</div>
<?php } ?>
...
<tr>
	...
	<td>
		...
		<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('¿Seguro que deseas eliminar esta subcategoría?')"><i class="icon-remove-sign"></i></a>
	</td>
</tr>
<?php $cnt=$cnt+1; } ?>
