...
<html lang="es">
	<head>
	    ...
	    <title>Portal de Compras - Página de Inicio</title>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Envío gratis en pedidos superiores a S/. 600.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Todos los artículos - hasta 20% de descuento</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Teléfonos Inteligentes</h3>
